            ...
            <div class="col-7">
                <form action="${Path.ADMIN_UPDATE_EDITION}" class="inputAdmin" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="title_uk" value="${editedEdition.titleUk}" placeholder="Title UKR" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="title_en" value="${editedEdition.titleEn}" placeholder="Title ENG" required>
                    ...
                    <div class="form-group">
                        <textarea type="textarea" class="form-control" value="${editedEdition.descriptionUk}" name="description_uk" placeholder="Description UKR"></textarea>
                    </div>

                    <div class="form-group">
                        <textarea type="textarea" class="form-control"  value="${editedEdition.descriptionEn}" name="description_en" placeholder="Description ENG"></textarea>
                    </div>
                    ...
                    <div class="form-group d-flex flex-row">
                        <select class="form-select" name="id_author" aria-label="Default select example" required>
                            ...
                            <c:forEach items="${adminPanelAuthors}" var="author">
                                <option value="${author.id}" <c:if test="${author.id == editedEdition.idAuthor}">selected</c:if>>${author}</option>
                            </c:forEach>
                    ...
                    <div class="form-group d-flex flex-row">
                        <input type="text" name="price" value="${editedEdition.price}" placeholder="Price">
                        <select class="form-select" name="measurement" aria-label="Default select example" required>
                            ...
                            <c:forEach items="${measurements}" var="meas">
                                <option value="${meas}"<c:if test="${meas == editedEdition.measurement}">selected</c:if>>${meas}</option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <button type="submit" class="btn btn-outline-success d-inline-block">Save changes</button>
                </form>
            </div>
